...
def read_power(timeout=6.0, skip=2, debug=True):
    ...
    try:
        ...
        while time.time() < deadline:
            ...
            if seen > skip or (last_power != watts and watts != 0 and seen != 0):
                last_power = watts
                return watts
...
ACCESS_TOKEN = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..YN8wlmGn-Mq_O3ykwvqfwk9iqBHYdwX04GFNR5FrmbGLHtUhkGaPFcjm0Hvuj60tPrJwDPu7j-OsdQAEtz50UZqWHk9r6DmUnOBs6dHdYekSBjf4NoQ8HV5PymTx43t07AGpP7Rjn7TOlXhCAOn4X1oxIfujCjkgtNBCnTYneEIC8_4OPPzS8nJsIP3BH9V-4__1MLuxGw386Ube6GBBzr6yPqRQGdzZt9fWLVCFbKzTqDU5aLbQvbU3wpHfX9kxz6c43lRisODSVJe4BEpirYQA9ip1hEiOZBssDYcQarhAS4BoiNMfiYgAxScDyMBhYM4GYD25yiVJWyThfG0fdQ"  # Replace with your valid token
...
def toggle_beep(toggle=False):
    ...
    payload = {
        ...
        "inputParam": {
            ...
            "00DC": {"v": 52},
            "00DD": {"v": 58},
            "00DE": {"v": 53.2 if toggle else 52.2},
            "00D6": {"v": "1"},
            "0146-14": {"v": "0"},
            "0146": {"v": "0"},
            "000F": {"v": "0"}
